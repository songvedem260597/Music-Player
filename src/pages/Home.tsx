...
import mv_song_1 from "../assets/images/mv_song_1.jpg";
import mv_song_2 from "../assets/images/mv_song_2.jpg";
import mv_song_3 from "../assets/images/mv_song_3.jpg";
...
const Home = () => {
  ...
  const songs = [
    {
      musicUrl:
        "https://songvedem260597.github.io/assets/mp3/bac_phan_remix.mp3",
    ...
    {
      musicUrl:
        "https://songvedem260597.github.io/assets/mp3/tinh_co_yeu_em.mp3",
      lrcUrl: "https://songvedem260597.github.io/assets/lrc/tinh_co_yeu_em.lrc",
      name: "Tình cờ yêu em",
      creator: "Huy Thộn",
      avatarUrl:
        "https://songvedem260597.github.io/assets/avatar/tinh_co_yeu_em.jpg",
      bannerUrl:
        "https://songvedem260597.github.io/assets/avatar/tinh_co_yeu_em.jpg",
      id: 2,
      index: 1,
    ...
    {
      musicUrl:
        "https://songvedem260597.github.io/assets/mp3/cung_danh_thoi.mp3",
      lrcUrl: "https://songvedem260597.github.io/assets/lrc/cung_danh_thoi.lrc",
      name: "Cũng đành thôi",
      creator: "Đức Phúc",
      avatarUrl:
        "https://songvedem260597.github.io/assets/avatar/cung_danh_thoi.jpg",
      bannerUrl:
        "https://songvedem260597.github.io/assets/avatar/cung_danh_thoi.jpg",
      id: 3,
      index: 2,
    ...
    {
      musicUrl:
        "https://songvedem260597.github.io/assets/mp3/somewhere_only_we_know.mp3",
      lrcUrl:
        "https://songvedem260597.github.io/assets/lrc/somewhere_only_we_know.lrc",
      name: "Somewhere Only We Know",
      creator: "Rhianne Cover",
      avatarUrl:
        "https://songvedem260597.github.io/assets/avatar/somewhere_only_we_know.jpg",
      bannerUrl:
        "https://songvedem260597.github.io/assets/avatar/somewhere_only_we_know.jpg",
      id: 5,
      index: 4,
  ...
  return (
    <div className="main-content">
      ...
      <div className="wrapper-content">
        ...
        <div className="ms-suggestion-song ms-artist-song">
          <p className="title-suggestion">Nghệ sĩ</p>
          <Carousel
            aspectRatio="16/9"
            slidesToShow={6}
            itemCount={6}
        ...
        <div className="ms-suggestion-song ms-artist-song">
          <p className="title-suggestion">MV Hot</p>
          <Carousel
            aspectRatio="16/9"
            slidesToShow={3}
            itemCount={3}
